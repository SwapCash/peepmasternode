...
const string strMessageMagic = "PeepMasternode Signed Message:\n";
...
{
    int64_t nSubsidy = 500;

    if(nBestHeight >= 1 && nBestHeight <= 100){
      nSubsidy = 0 * COIN;
    } else if(nBestHeight >= 100 && nBestHeight < 100000){
      nSubsidy = 2 * COIN;
      ...
      nSubsidy = 1600 * COIN;
    } else if(nBestHeight >= 2000000 && nBestHeight < 2500000){
      nSubsidy = 1400 * COIN;
    } else if(nBestHeight >= 2500000 && nBestHeight < 3000000){
      nSubsidy = 1200 * COIN;
    } else{
      nSubsidy = 500 * COIN;
    }
...
{
    RenameThread("PeepMasternode-loadblk");
